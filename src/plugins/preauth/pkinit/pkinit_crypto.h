...
/**
 * An ordered set of OIDs, stored as krb5_data, of CMS signature algorithms
 * supported by this implementation. It is ordered by decreasing preference.
 */
extern krb5_data const * const supported_cms_signature_ids[];
